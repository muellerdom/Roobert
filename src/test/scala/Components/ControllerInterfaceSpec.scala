...
import Controller.Component.ControllerMockImpl.MockController
import Model.LevelComponent.LevelConfig
import Model.SpielfeldComponent.{Coordinate, SpielfeldInterface}
import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should.Matchers

class ControllerInterfaceSpec extends AnyFlatSpec with Matchers {

  "ControllerInterface" should "start a level" in {
